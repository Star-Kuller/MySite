...
using MySite.Application.Infrastructure;
using MySite.Application.Interfaces.Mapping;
using MySite.Domain.Entities.User;

namespace MySite.Application.Features.Account;

public class Register
{
    public class Command : IRequest<string>, IHaveCustomMapping
    {
